...
void ReAnaEffTnP(int CentMin, int CentMax,	const int NBins,	int DoTwoD, int drop, int Weight, int TnPOpt){
	...
	if(TnPOpt == 0){
		TnPMapNameUp = "invEff2DMuidUp";
		TnPMapNameDown = "invEff2DMuidDown";
	}


	if(TnPOpt == 1){
		TnPMapNameUp = "invEff2DTrkUp";
		TnPMapNameDown = "invEff2DTrkDown";
	}

	if(TnPOpt == 2){
		TnPMapNameUp = "invEff2DTrgUp";
		TnPMapNameDown = "invEff2DTrgDown";
	}


	if(TnPOpt == 3){
		TnPMapNameUp = "invEff2DSystUp";
		TnPMapNameDown = "invEff2DSystDown";
	}
	...
	c->SaveAs(Form("TnPPlots/%s/pdfForGJ/TnPEffComp_%dBins_%d_%d.pdf",TnPName[TnPOpt].Data(),NBins,CentMin,CentMax));
	...
	c->SaveAs(Form("TnPPlots/%s/pdfForGJ/SystTnPRatio_%dBins_%d_%d.pdf",TnPName[TnPOpt].Data(),NBins,CentMin,CentMax));
