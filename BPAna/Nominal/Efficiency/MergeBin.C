...
void MergeBin(){
	...
	TString File030 = "CheckSystNuno/NoTnP/Fixed/NewCorr_0_30.root";
	TString File3090 = "CheckSystNuno/NoTnP/Fixed/NewCorr_30_90.root";
	...
	TFile * fout = new TFile("CrossSectionPbPbBPlus.root","RECREATE");
	fout->cd();
	hPtSigma->Write();
	fout->Close();
