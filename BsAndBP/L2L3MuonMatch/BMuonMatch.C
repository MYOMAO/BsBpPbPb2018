...
void BMuonMatch(int CentMin, int CentMax,int Option){
	...
	TString infile = Form("Output/%s/EffInfo_%d_%d.root",BType.Data(),CentMin,CentMax);
	...
	TString OutputFileName = Form("FinalFiles/%s/MuonInfo_%d_%d.root",BType.Data(),CentMin,CentMax);
