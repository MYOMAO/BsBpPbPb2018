...
TCut weightGpt_PbPb_DataCentral= "(0.721594 + 0.017661 * Gpt)*((16.803153)*TMath::Exp(-0.410200 * Gpt) + 0.275632)";
TCut weightBgenpt_PbPb_DataCentral= "(0.721594 + 0.017661 * Bgenpt)*((16.803153)*TMath::Exp(-0.410200 * Bgenpt) + 0.275632)";

//Weight Data Driven + 1 Sigma//

TCut weightGpt_PbPb_Data1PS= "(0.721594 + 0.029704 * Gpt)*((16.803153)*TMath::Exp(-0.410200 * Gpt) + 0.275632)";
TCut weightBgenpt_PbPb_Data1PS= "(0.721594 + 0.029704 * Bgenpt)*((16.803153)*TMath::Exp(-0.410200 * Bgenpt) + 0.275632)";


//Weight Data Driven - 1 Sigma//

TCut weightGpt_PbPb_Data1MS= "(0.721594 + 0.005618 * Gpt)*((16.803153)*TMath::Exp(-0.410200 * Gpt) + 0.275632)";
TCut weightBgenpt_PbPb_Data1MS= "(0.721594 + 0.005618 * Bgenpt)*((16.803153)*TMath::Exp(-0.410200 * Bgenpt) + 0.275632)";
...
TCut weightGpt_PbPb_NominalPP= "(12.248948)*TMath::Exp(-0.432495 * Gpt) + 0.654161";
TCut weightBgenpt_PbPb_NominalPP= "(12.248948)*TMath::Exp(-0.432495 * Bgenpt) + 0.654161";



//Variation PP//

TCut weightGpt_PbPb_VariationPP= "(21.396755)*TMath::Exp(-0.507617 * Gpt) + 0.660621";
TCut weightBgenpt_PbPb_VariationPP= "(21.396755)*TMath::Exp(-0.507617 * Bgenpt) + 0.660621";


//Nominal TAMU//


TCut weightGpt_PbPb_NominalTAMU= "(19.873656)*TMath::Exp(-0.399562 * Gpt) + 0.276395";
TCut weightBgenpt_PbPb_NominalTAMU= "(19.873656)*TMath::Exp(-0.399562 * Bgenpt) + 0.276395";

//Variation TAMU//

TCut weightGpt_PbPb_VariationTAMU= "(22.466352)*TMath::Exp(-0.415859 * Gpt) + 0.278864";
TCut weightBgenpt_PbPb_VariationTAMU= "(22.466352)*TMath::Exp(-0.415859 * Bgenpt) + 0.278864";
*/
