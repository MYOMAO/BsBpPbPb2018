...
TString weightgen="1";
TString weightmc="1";
TString weightdata="2";
TString weightdatareal[2]={"(1/0.131733+TMath::Exp(-1.051514*(Bpt-15.468517))+TMath::Exp(-0.204272*(Bpt-31.002324)))","(1/0.204307+TMath::Exp(-1.041731*(Bpt-14.608514))+TMath::Exp(-0.206513*(Bpt-27.599694)))"};
...
double sf_pbpb[2] = {1.1009, 1.1094 };
