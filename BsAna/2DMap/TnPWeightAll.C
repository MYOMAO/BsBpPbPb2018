...
void TnPWeightAll(int Opt, int DoWeight){
	...
	if(Opt == 0){
		...
		if(DoWeight == 0) outfile = "BsTnPNoInfo.root";
		if(DoWeight == 1) outfile = "BsTnPmuidInfo.root";
		if(DoWeight == 2) outfile = "BsTnPtrkInfo.root";
		if(DoWeight == 3) outfile = "BsTnPmuidtrkInfo.root";
		if(DoWeight == 4) outfile = "BsTnPTotalInfo.root";
	...
	if(Opt == 1){
		...
		if(DoWeight == 0) outfile = "BPTnPNoInfo.root";
		if(DoWeight == 1) outfile = "BPTnPmuidInfo.root";
		if(DoWeight == 2) outfile = "BPTnPtrkInfo.root";
		if(DoWeight == 3) outfile = "BPTnPmuidtrkInfo.root";
		if(DoWeight == 4) outfile = "BPTnPTotalInfo.root";
