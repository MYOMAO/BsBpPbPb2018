...
*/
	...
	double sigma1Value;
	double sigma2Value;
	double sig1fracValue;

	if(ptmin == 10 && ptmax == 50){

		sigma1Value = 0.0246742;
		sigma2Value = 0.0103917;
		sig1fracValue = 0.353958;
