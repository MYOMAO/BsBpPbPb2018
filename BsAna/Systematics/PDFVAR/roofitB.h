...
//	Significance = roundToNdigit(Significance);
	...
	ofstream Sigdat(Form("Significance_%.0f_%.0f_%.0f_%.0f.dat",ptmin,ptmax,centmin,centmax), ios::app);

	Sigdat << variation.Data() << "   " << pdf.Data() << "  " << Significance << endl;
